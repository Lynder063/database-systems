...
9. Vypište tréninky _(pouze atributy tréninků)_, které odcvičili včera lektoři s kvalifikací "Fyzioterapeut".
...
HEREC\*FILM (\*\*\*_id_herec\***\*, \*\***id_film\***\*)  
FILM_OCENĚNÍ (\*\***id_film\***\*, \*\***id_ocenění_\_\*\*)
